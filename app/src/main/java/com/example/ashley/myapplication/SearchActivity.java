...
public class SearchActivity extends SlidingActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int from = intent.getIntExtra("from",0);
                            ...
                            public void onResult(PlaceBuffer places) {
                                if(places.getCount()==1){
                                   ...
                                   // Toast.makeText(getApplicationContext(),String.valueOf(places.get(0).getLatLng()),Toast.LENGTH_SHORT).show();
                                    ...
                                    intent.putExtra("result",item.description);
                                    if( from == 1)
                                    {
                                        setResult(4,intent);
                                    }
